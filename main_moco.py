...
def train(train_loader, model, criterion, optimizer, epoch, args, indx):
    ...
    for i, (images, _) in enumerate(train_loader):
        ...
        output, target, output_max, target_max, backbone, featcov16, featmap, att_max, gradcam = model(im_q=images[0], im_k=images[1], epoch=epoch, iter=i, indx=indx)
        ...
        total_loss = loss + args.nu * loss_cam
